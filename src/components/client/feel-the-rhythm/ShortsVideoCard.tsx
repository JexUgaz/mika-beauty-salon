...
const ShortsVideoCard: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="relative max-w-[100dvw] aspect-[9/16] h-full sm:w-auto sm:h-[calc(100dvh-var(--h-navbar)-20px)] sm:mx-auto sm:mt-[10px]">
      ...
      {/* <div className="absolute bottom-15 left-0 w-full h-[30%] bg-gradient-to-t from-black/80 to-transparent z-0 pointer-events-none sm:rounded-4xl" /> */}

      <div className="absolute bottom-15 left-5 text-white z-10 max-w-[80%]">
